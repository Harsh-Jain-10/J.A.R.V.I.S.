...
class Brain:
    ...
    def classify_intent(self, user_message: str) -> str:
        ...
        prompt = (
            ...
            f"- NEWS: only if user explicitly asks for 'news', 'headlines', or 'top stories'. Do NOT classify general interest queries (e.g. when a TV show starts) as NEWS; classify them as WEB_SEARCH.\n"
            ...
            f"- CHAT: general conversation, greetings, small-talk, asking for current date or time, or anything else.\n\n"
